package com.zainal.android.catalogue.ui.tvShow
...
import com.zainal.android.catalogue.search.SearchResultActivity
import com.zainal.android.catalogue.settings.SettingsActivity
import com.zainal.android.catalogue.viewmodels.SearchViewModel
import com.zainal.android.catalogue.viewmodels.TvShowViewModel
...
class TvShowFragment : Fragment() {
    ...
    private fun showTv() {
        ...
        tvShowAdapter.setOnItemClickCallback(object : TvShowAdapter.OnItemClickCallback {
            override fun onItemClicked(data: TvShow) {
                ...
                detailTvShow.putExtra(DetailTvShowActivity.EXTRA_TV_SHOW, data)
    ...
    private fun showLoading(state: Boolean) {
        if (state) {
            ...
            pb_tv.visibility = View.INVISIBLE
        }
    }
}